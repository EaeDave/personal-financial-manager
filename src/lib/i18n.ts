  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        addRecurringExpenseDesc: 'Track a recurring or one-time bill.',
        settings: 'Settings',
        dashboard: 'Dashboard',
  ...
  pt: {
    translation: {
      ...
      dashboard: {
        ...
        addRecurringExpenseDesc: 'Monitore uma conta recorrente ou única.',
      ...
      auth: {
        ...
        loginSubtitle: 'Entre para gerenciar suas finanças',
        registerSubtitle: 'Crie sua conta para começar',
        loginDesc: 'Insira suas credenciais para acessar sua conta.',
        registerDesc: 'Preencha seus dados para criar uma nova conta.',
        loginButton: 'Entrar',
